# The name of this view in Looker is "Vkfe Ero Al Ga Fl Zip Code City"
view: vkfe_ero_al_ga_fl_zip_code_city {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `VKFE_ERO_Looker.VKFE_ERO_AL_GA_FL_ZipCode_City` ;;
